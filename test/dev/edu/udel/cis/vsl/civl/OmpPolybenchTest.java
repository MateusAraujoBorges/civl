...
/**
 * OMP transformer testing on LLNL polybench(part of dataracebench).
 * TODO: Need to change <polybench.h> to "utilities/polybench.h" in c source.
 *       any better ways?
 * 
 * @author dxu
 */
...
public class OmpPolybenchTest {
    ...
    private void check(String filenameRoot, boolean debug) throws ABCException,
        ...
        ui.run("verify",
                ...
                "-DPOLYBENCH_TIME ", filename(filenameRoot+".c"),
                "examples/omp/dataracebench-1.0.0/micro-benchmarks/utilities/polybench.c"
                );

//        assertTrue(ui.run("show", "-showModel", "-ompNoSimplify", filename(filenameRoot+".c")));
